        ...
        <div class="row row-xs">
            ...
            <div class="col-sm-6 col-lg-4 mg-t-10 mg-sm-t-0">
                <div class="card card-body">
                    ...
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        <h4 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">3.137</h4>
                    ...
                    <ul class="list-group list-group-flush tx-13">
                        <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="pd-sm-l-10">
                                <p class="tx-medium mg-b-0">Proposta #10322</p>
                                <small class="tx-12 tx-color-03 mg-b-0"> 22/10/2019</small>
                            </div>
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="pd-sm-l-10">
                                <p class="tx-medium mg-b-2">Proposta #00910</p>
                                <small class="tx-12 tx-color-03 mg-b-0">13/09/2019</small>
                            </div>
                            <div class="mg-l-auto text-right">
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="pd-sm-l-10">
                                <p class="tx-medium mg-b-2">Proposta #44333</p>
                                <small class="tx-12 tx-color-03 mg-b-0">11/09/2019</small>
                            </div>
                            <div class="mg-l-auto text-right">

                                <small class="tx-12 tx-info mg-b-0">Pendente</small>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="pd-sm-l-10">
                                <p class="tx-medium mg-b-0">Proposta #087651</p>
                                <small class="tx-12 tx-color-03 mg-b-0">08/08/2019</small>
                            </div>
                            <div class="mg-l-auto text-right">

                                <small class="tx-12 tx-danger mg-b-0">Rejeitada</small>
                            </div>
                        </li>
                    </ul>
                    <div class="card-footer text-center tx-13">
                        <a href="" class="link-03">Ver todas as propostas <i class="icon ion-md-arrow-down mg-l-5"></i></a>
                    </div><!-- card-footer -->
                </div><!-- card -->
            </div>
                ...
                <div class="card ht-100p">
                    ...
                    <ul class="list-group list-group-flush tx-13">
                        <li class="list-group-item d-flex pd-sm-x-20">
                            ...
                            <div class="pd-l-10">
                                <p class="tx-medium mg-b-0">Shopping Iguatemi</p>
                                <small class="tx-12 tx-color-03 mg-b-0">ID#00222</small>
                            </div>
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                            ...
                            <div class="pd-l-10">
                                <p class="tx-medium mg-b-0">Beira mar Shopping</p>
                                <small class="tx-12 tx-color-03 mg-b-0">ID#00221</small>
                            </div>
                            <div class="mg-l-auto d-flex align-self-center">
                                <nav class="nav nav-icon-only">
                                    <a href="" class="nav-link d-none d-sm-block"><i data-feather="mail"></i></a>
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                            ...
                            <div class="pd-l-10">
                                <p class="tx-medium mg-b-0">Floripa Shopping</p>
                                <small class="tx-12 tx-color-03 mg-b-0">ID#00220</small>
                            </div>
                            <div class="mg-l-auto d-flex align-self-center">
                                <nav class="nav nav-icon-only">
                                    <a href="" class="nav-link d-none d-sm-block"><i data-feather="mail"></i></a>
                    ...
                    <div class="card-footer text-center tx-13">
                        <a href="" class="link-03">Ver todos os Clientes <i class="icon ion-md-arrow-down mg-l-5"></i></a>
                    </div><!-- card-footer -->
                </div><!-- card -->
            </div>
