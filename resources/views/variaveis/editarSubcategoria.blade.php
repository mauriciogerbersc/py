...
<div class="content content-fixed">
    <div class="container">
        <ol class="breadcrumb df-breadcrumbs mg-b-10">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar Tabela de Preços</li>
        </ol>

        <form method="POST" id="formulario" action="/variaveis/subcategorias/editar/{{$subFixos['id']}}">
