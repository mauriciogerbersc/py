...
<div class="content content-fixed">
    <div class="container">
        ...
        <h4 id="section4" class="mg-b-10">Editar Categoria</h4>

        <div class="tx-14 mg-b-25">
            <form method="POST" action="/variaveis/categorias/editar/{{$categoria->id}}">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        type="text" class="form-control @error('nome') is-invalid @enderror" 
