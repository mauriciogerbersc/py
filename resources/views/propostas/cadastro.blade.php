...
<div class="content content-fixed">
    <div class="container">
        <ol class="breadcrumb df-breadcrumbs mg-b-10">
            ...
            <li class="breadcrumb-item"><a href="./propostas.html">Propostas</a></li>
                    ...
                    <section>
                        ...
                        <div class="form-group">
                            <label for="estabelecimento" class="d-block">A qual shopping destina-se esse
                                projeto?</label>
                            <input type="text" class="form-control" name="estabelecimento" placeholder="Informe o nome do Estabelecimento">
                        </div>

                        <div class="form-group">
                            <label for="nomeEmitido" class="d-block">Em nome de quem a proposta será emitida?</label>
                            <input type="text" class="form-control" name="responsavel" placeholder="Informe o nome do responsável">
                        </div>
                    ...
                    <section>
                        ...
                        <table class="table" id="tabelaParques">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <span class="badge badge-primary" style="padding:5px 4px !important;">
                                            <i class="icon ion-md-help" data-toggle="tooltip" data-placement="bottom" title="Informe a altura desejada do sistema dentre 2 metros e 2,5 metros do chão, de acordo com a possibilidade de seu 
                            ...
                            <tbody id="tbody">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" id="nomeParque" name="nomeParque[]" placeholder="Ex: G1">
                                    </td>

                                    <td>
                                        <input type="number" class="form-control" id="quantidadeVagasInternas" name="quantidadeVagasInternas[]" value="0">
                                    </td>

                                    <td>
                                        <input type="number" class="form-control" id="quantidadeVagasExternas" name="quantidadeVagasExternas[]" value="0">
                                    </td>

                                    <td>
                                        <input type="text" class="form-control" id="alturaSistema" name="alturaSistema[]" value="0">
                                    </td>

                                    <td>
                                        <input type="text" class="form-control" id="peDireito" name="peDireito[]" value="0">
                                    </td>
                        ...
                        <div class="form-group">
                            <label for="sistemaGravacao" class="d-block">
                                ...
                                Se desejar a ampliação de dias de gravação do sistema, favor inserir o número de dias extras.
                            </label>
                        ...
                        <div class="form-row">
                            <label for="sistemaGravacao" class="d-block">
                                Se você gostaria de instalar câmeras em locais estratégicos como corredores, hall de entrada, depósitos,
                        ...
                        <div class="form-group">
                            <label for="quantosPaineisSinalizados" class="d-block">Quantos painéis de sinalização de vagas internos você gostaria de instalar?
                        ...
                        <div class="form-group">
                            <label for="" class="d-block">
                                Qual a distância em metros entre o Centro de Controle e o G1?
                        ...
                        <div class="form-group">
                            <label for="" class="d-block">
                                Some as distâncias de interligação do G1 até os demais parques de estacionamento,
                        ...
                        <div class="form-row">
                            <label for="" class="d-block">O ParkEyes Outdoor é um sistema de controle de número de veículos dentro de
                                um parque de estacionamento descoberto, se há interesse nesse controle, favor informar o número de entradas e
                                saídas que acessam a totalidade dos parques descobertos.</label>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" name="qtdEntradas" value="0" placeholder="entradas">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <label for="sistemaGravacao" class="d-block">Deseja instalar câmeras LPR para leitura de placar quanto um veículo acessa,
                        ...
                        <div class="form-row">
                            <label for="quantidadeAcessosExternos" class="d-block">
                                Quantos acessos externos possui Shopping? Considerando as caixas de passagem e shafts disponíveis no Shopping,
                                informe também a distância de cada acesso externo até o parque de estacionamento coberto mais próximo.
                            </label>
                            <div class="form-group col-md-12">
                        ...
                        <div class="form-row" id="acessosExternos">
                            <div class="form-group col-md-4  d-flex align-items-end" id="paraClonar">
                                <input type="text" class="form-control" name="nomeAcessoExterno[]" placeholder="Nomeie o acesso">
                            </div>
                        </div>

                        <div class="form-row linhasPaineis">
                            <label class="d-block">Informe quantas linhas serão necessárias para os painéis externos localizados nos seguintes acessos?</label>
                        </div>
                        ...
                        <div class="form-row distanciaLinhas">
                            <label class="d-block">Informe a distância do acesso abaixo até o parque de estacionamento coberto mais próximo?</label>
                        </div>
                        ...
                        <div class="form-row">
                            <label for="camerasLPR" class="d-block">Deseja instalar câmeras LPR para leitura de placas quando um veículo acessa,
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="totensFindYourCar" class="d-block">
                                    ...
                                    preferência a colocação de um totem ao lado de cada guichê de cobrança de estacionamento)
                                </label>
                            </div>
