                    ...
                    <div class="table-responsive mg-t-40">
                                ...
                                <tr>
                                    ...
                                    <td class="tx-center">
                                        ...
                                        <input type="hidden" class="quantidade"
                                            value="{!! Helper::regraDeNegocio($val['regra_de_negocio'], $val['variavel_id'], $proposta->id) !!}" />
                                    </td>
                        ...
                        <table id="tbl2" class="table table-dark table-hover table-striped mg-b-0 somarTabela">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$val['nome']}} {{$val['variavel_id']}}</td>
                                    <td>
                                        @if($val['preco']==0)
                        ...
                        <table class="table table-light bd-b somarTabela">
                            <thead>
                                <tr>
                                    <th class="wd-40p">{{$categoria->nome}}</th>
                                    <th class="wd-20p">Preços</th>
                            ...
                            <tbody>
                                @foreach(Helper::retornaVariaveis($proposta->cliente_id, 6) as $key=>$val)
                                <tr>
                                    <td>{{$val['nome']}}</td>
                                    <td>
                                        @if($val['preco']==0)
                        ...
                        <table class="table table-light bd-b somarTabela">
                            ...
                            <tbody>
                                @foreach(Helper::retornaVariaveis($proposta->cliente_id, 8) as $key=>$val)
                                <tr>
                                    <td>{{$val['nome']}}</td>
                                    <td>
                                        @if($val['preco']==0)
                        ...
                        <table class="table table-light bd-b somarTabela">
                            ...
                            <tbody>
                                @foreach(Helper::retornaVariaveis($proposta->cliente_id, 10) as $key=>$val)
                                <tr>
                                    <td>{{$val['nome']}}</td>
                                    <td>
                                        @if($val['preco']==0)
                        ...
                        <table class="table table-light bd-b somarTabela">
                            ...
                            <tbody>
                                @foreach(Helper::retornaVariaveis($proposta->cliente_id, 11) as $key=>$val)
                                <tr>
                                    <td>{{$val['nome']}}</td>
                                    <td>
                                        @if($val['preco']==0)
