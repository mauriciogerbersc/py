...
<div class="content content-fixed">
    <div class="container">
        <ol class="breadcrumb df-breadcrumbs mg-b-10">
            ...
            <li class="breadcrumb-item"><a href="/vagas">Vagas</a></li>
            ...
            <form method="POST" action="/vagas/nova_subcategoria">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input id="valor" type="text" class="form-control @error('valor') is-invalid @enderror valores" name="valor" data-thousands=""  data-decimal="." autocomplete="valor">
