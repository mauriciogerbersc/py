...
<div class="content content-fixed">
    <div class="container">
        <ol class="breadcrumb df-breadcrumbs mg-b-10">
            ...
            <li class="breadcrumb-item"><a href="/clientes">Gerenciamento de Clientes</a></li>
            <li class="breadcrumb-item active" aria-current="page">Editar Cliente</li>
        </ol>


        <h4 id="section4" class="mg-b-10">Editar Cliente</h4>
            ...
            <form method="POST" action="/clientes/editar/{{$cliente['id']}}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="categoriaPrecos" class="custom-select">
                            @foreach($subFixo as $sub)
                                <option value="{{$sub['id']}}" {{ $sub->id == $cliente['sub_fixo_id'] ? "selected" : ""}}>{{$sub['nomeSub']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="senhaCliente">Senha (só atualize a senha caso realmente deseje altera-la)</label>
